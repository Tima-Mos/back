...
public class UserAuthService {
    ...
    @Autowired
    public UserAuthService(UserCrudService userCrudService, AuthenticationManager authenticationManager, UserDetailsService userDetailsService, JwtTokenService jwtTokenService) {
